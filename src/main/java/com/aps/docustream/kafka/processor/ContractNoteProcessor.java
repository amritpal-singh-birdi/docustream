...
public class ContractNoteProcessor implements DocumentProcessor {
	
	private final DocustreamRepository repository;
	private final PdfGenerationService pdfGenerationService;
	
	public ContractNoteProcessor(DocustreamRepository repository, PdfGenerationService pdfGenerationService) {
	...
	public void process(String documentId) {
		...
		byte[] pdfBytes = pdfGenerationService.generatePDF(payload, documentId, DocumentType.CONTRACT_NOTE, payloadType);
